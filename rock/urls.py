...
urlpatterns = [
    ...
    # Location
    path('location/<int:sport_id>/publish', views.publish_location, name='publish_location'),
    path('location/<int:sport_id>/create', views.create_location, name='create_location'),
