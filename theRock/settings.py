...
# aws settings
AWS_ACCESS_KEY_ID = os.getenv('AKIAUKZMSF224FPWY5YM')
AWS_SECRET_ACCESS_KEY = os.getenv('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')
...
DEFAULT_FILE_STORAGE = 'theRock.storage_backends.MediaStorage'
